...
class GeneralPref(wx.Panel):
  ...
  def _initControls(self):
    ...
    self._srt_combo = wx.Choice(self, wx.ID_ANY, wx.DefaultPosition, wx.Size(130, -1), 
                                [u"tag.srt", u"notag.srt", u"tag&notag.srt"])
    self._srt_combo.SetSelection(2)
    
    self._zip_combo = wx.Choice(self, wx.ID_ANY, wx.DefaultPosition, wx.Size(105, -1),
    ...
    general_boxsizer.Add(self._zip_combo)#, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALIGN_CENTER_HORIZONTAL, 20)
...
class AssPref(wx.Panel):
  ...
  def initControls(self):
    ...
    self.fontChooser = wx.Choice(self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, [u"Arial", u"Comic Sans MS", u"Verdana" ])
    ...
    self.fontSizeChooser = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(30, -1))    
    ...
    #PrimaryColour, SecondaryColour, OutlineColour, BackColour, ScaleX, ScaleY, Spacing, Angle, 
    #BorderStyle, Outline, Alignment, MarginL, MarginR, MarginV, Encoding
